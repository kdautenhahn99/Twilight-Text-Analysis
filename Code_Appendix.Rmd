...
This chart is not included in the paper discussion, but showcases the top 10 most frequent words in the Twilight Series as well as Midnight Sun. One interesting note is that "her" is the 4th most frequent word in Midnight Sun while "he" is the 6th most frequent word in the Twilight Series.
...
This code chunk creates a keyness table from the Edward and Bella dfm objects. The columns for Deviation of Proportions (DP) for both the target and reference corpora are ignored since they are not used in the study. The PV column shows highly significant p-values for all of the top 5 tokens. The top two results are discussed in the paper, but the top 5 are shown here. The remaining 3 tokens have high LL values likely due to tokenizing differences between the two corpora and should not be regarded as significantly.
